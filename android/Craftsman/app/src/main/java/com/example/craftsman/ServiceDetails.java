...
public class ServiceDetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    ServiceCommentMyAdapter myAdapter;
    ArrayList<ServiceCommentModel> commentList;
    private static final String GET_COMMENT_URL = "https://aboodbarqawi.000webhostapp.com/craftman/getServiceComment.php";
    private static final String GET_Rating_URL = "https://aboodbarqawi.000webhostapp.com/craftman/getServiceRating.php";
    private static final String POST_COMMENT_URL = "https://aboodbarqawi.000webhostapp.com/craftman/saveServiceComment.php";
    private static final String POST_Rating_URL = "https://aboodbarqawi.000webhostapp.com/craftman/saveServiceRating.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(ServiceDetails.this).load(str_image).into(img);
        loadComments(str_id);
        loadRating(str_id);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i= 0; i<service.length();i++){
                                ...
                                ServiceCommentModel p = new ServiceCommentModel();
                                p.setComment(comment);
                                commentList.add(p);
                            }
                            myAdapter = new ServiceCommentMyAdapter(ServiceDetails.this, commentList);
...
//                Toast.makeText(ServiceDetails.this, error.getMessage(),Toast.LENGTH_SHORT).show();
                Toasty.error(ServiceDetails.this, error.getMessage(), Toasty.LENGTH_LONG,true).show();
            }
        }){
            @Override
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try{
                                ...
                                if(success.equals("1"))
                                {
//                                    Toast.makeText(ServiceDetails.this,"Add Comment Success!",Toast.LENGTH_SHORT).show();
                                    Toasty.success(ServiceDetails.this, "Add Comment Success!", Toasty.LENGTH_LONG,true).show();
                                    Intent intent  = new Intent(ServiceDetails.this,Categories.class);

                                    startActivity(intent);
                                }
                                else if(success.equals("0"))
                                {
//                                    Toast.makeText(ServiceDetails.this,"Add Comment Failed! ",Toast.LENGTH_SHORT).show();
                                    Toasty.error(ServiceDetails.this, "Add Comment Failed! ", Toasty.LENGTH_LONG,true).show();
                                ...
                                e.printStackTrace();
                                //if error occur
//                                Toast.makeText(ServiceDetails.this,"Add Comment Error!"+ e.toString(),Toast.LENGTH_SHORT).show();
                                Toasty.error(ServiceDetails.this, "Add Comment Error!"+ e.toString(), Toasty.LENGTH_LONG,true).show();
                ...
                @Override
                public void onErrorResponse(VolleyError error) {
//                    Toast.makeText(ServiceDetails.this,"Add Comment Error!"+ error.toString(),Toast.LENGTH_SHORT).show();
                    Toasty.error(ServiceDetails.this, "Add Comment Error!"+ error.toString(), Toasty.LENGTH_LONG,true).show();
                    loading_comment.setVisibility(View.GONE);
                    save_comment_btn.setVisibility(View.VISIBLE);
                }
            })
            ...
            loading_comment.setVisibility(View.GONE);
            save_comment_btn.setVisibility(View.VISIBLE);
//            Toast.makeText(ServiceDetails.this,"Please Check your Entries",Toast.LENGTH_SHORT).show();
            Toasty.error(ServiceDetails.this, "Please Check your Entries", Toasty.LENGTH_LONG,true).show();
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try{
                                ...
                                if(success.equals("1"))
                                {
                                    //Toast.makeText(ServiceDetails.this,"Add rating Success!",Toast.LENGTH_SHORT).show();
                                    Toasty.success(ServiceDetails.this, "Add rating Success!", Toasty.LENGTH_LONG,true).show();

                                }
                                else if(success.equals("0"))
                                {
//                                    Toast.makeText(ServiceDetails.this,"Add rating Failed! ",Toast.LENGTH_SHORT).show();
                                    Toasty.error(ServiceDetails.this, "Add rating Failed! ", Toasty.LENGTH_LONG,true).show();
                                    loading_comment.setVisibility(View.GONE);
                                    save_comment_btn.setVisibility(View.VISIBLE);
                                }
                            } catch (JSONException e) {
                                e.printStackTrace();
                                //if error occur
//                                Toast.makeText(ServiceDetails.this,"Add rating Error!"+ e.toString(),Toast.LENGTH_SHORT).show();
                                Toasty.error(ServiceDetails.this, "Add rating Error!"+ e.toString(), Toasty.LENGTH_LONG,true).show();
                ...
                @Override
                public void onErrorResponse(VolleyError error) {
//                    Toast.makeText(ServiceDetails.this,"Add rating Error!"+ error.toString(),Toast.LENGTH_SHORT).show();
                    Toasty.error(ServiceDetails.this, "Add rating Error!"+ error.toString(), Toasty.LENGTH_LONG,true).show();
...
//            Toast.makeText(ServiceDetails.this,"Please Check your Entries",Toast.LENGTH_SHORT).show();
    ...
    public void makePhoneCall(String phone){
      if(ContextCompat.checkSelfPermission(ServiceDetails.this, Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){
          ActivityCompat.requestPermissions(ServiceDetails.this, new String[]{Manifest.permission.CALL_PHONE},1);
      }else{
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode == REQUEST_CALL){
            if(grantResults.length >0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
               ...
               // Toast.makeText(ServiceDetails.this, "Permission Denied ", Toast.LENGTH_LONG).show();
                Toasty.error(ServiceDetails.this,"Permission Denied ", Toasty.LENGTH_LONG,true).show();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.home:
                intent =  new Intent(ServiceDetails.this,Categories.class);
                startActivity(intent);
...
//                startActivity(intent);
            ...
            case R.id.my_profile:
                intent =  new Intent(ServiceDetails.this,Profile.class);
                startActivity(intent);
                mDrawerLayout.closeDrawer(GravityCompat.START);
                break;
            case R.id.logout:
                ...
                break;
            case R.id.add_post:
                intent =  new Intent(ServiceDetails.this,AddPost.class);
                startActivity(intent);
                mDrawerLayout.closeDrawer(GravityCompat.START);
                break;
        }
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try{
                                ...
                                if(success.equals("1"))
                                {
//                                    Toast.makeText(ServiceDetails.this,"Send Report Success!",Toast.LENGTH_SHORT).show();
                                    Toasty.success(ServiceDetails.this, "Send Report Success!", Toasty.LENGTH_LONG,true).show();
                                    Intent intent  = new Intent(ServiceDetails.this,Categories.class);
                                ...
                                {
//                                    Toast.makeText(ServiceDetails.this,"Send Report Failed! ",Toast.LENGTH_SHORT).show();
                                    Toasty.error(ServiceDetails.this, "Send Report Failed! ", Toasty.LENGTH_LONG,true).show();
                                ...
                                e.printStackTrace();
                                //if error occur
//                                Toast.makeText(ServiceDetails.this,"Send Report Error!"+ e.toString(),Toast.LENGTH_SHORT).show();
                                Toasty.error(ServiceDetails.this, "Send Report Error!"+ e.toString(), Toasty.LENGTH_LONG,true).show();
                                loading_report.setVisibility(View.GONE);
                                save_report_btn.setVisibility(View.VISIBLE);
                            }
                ...
                @Override
                public void onErrorResponse(VolleyError error) {
//                    Toast.makeText(ServiceDetails.this,"Send Report Error!"+ error.toString(),Toast.LENGTH_SHORT).show();
                    Toasty.error(ServiceDetails.this, "Send Report Error!"+ error.toString(), Toasty.LENGTH_LONG,true).show();
                    loading_report.setVisibility(View.GONE);
                    save_report_btn.setVisibility(View.VISIBLE);
                }
            })
            ...
            save_report_btn.setVisibility(View.VISIBLE);
//            Toast.makeText(ServiceDetails.this,"Please Check your Entries",Toast.LENGTH_SHORT).show();
            Toasty.warning(ServiceDetails.this, "Please Check your Entries", Toasty.LENGTH_LONG,true).show();
